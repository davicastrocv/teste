                    ...
                    <div class="row">
                        <div class="col-lg-10 mx-auto">
                            <div class="career-search mb-60">
                                ...
                                <form action="{{ route('index_financeiro') }}" class="career-form mb-30" method="POST">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-3 my-3">
                                            ...
                                            <button type="button" class="btn btn-lg  btn-light" id="contact-submit"
                                                onclick="location.href = '{{ route('index_financeiro') }}'">
                                                Todos
                                            </button>
                                        </div>
                                    </div>
...
<script>
    function carregaArquivosPorFilial(fil, mes, ano) {
        $.ajax({
            type: 'get',
            url: "/recebidos/carrega_arquivos_financeiro",
            data: {
                filial: fil,
                mes: mes,
                ano: ano
